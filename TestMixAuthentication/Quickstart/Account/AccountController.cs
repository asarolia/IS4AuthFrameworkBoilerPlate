...
using TestIdentityServerAuthentication;
...
namespace IdentityServerHost.Quickstart.UI
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Register(RegisterInputModel Input, string ReturnUrl)
        {
            ...
            // something went wrong, return by doing nothing
           
            return Redirect(Input.ReturnUrl);

        }

        //public async Task<RegisterViewModel> BuildRegisterViewModelAsync(RegisterInputModel model)
        //{
        ...
        public async Task<IActionResult> Login(LoginInputModel model, string button)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    // To implement MFA processing

                   // return RedirectToPage("./LoginWith2fa", new { ReturnUrl = returnUrl, RememberMe = Input.RememberMe });
                }
                if (result.IsLockedOut)
                {
                    // To implement account lock out processing here 
